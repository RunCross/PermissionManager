...
public class PermissionRequestTaskStartFragmentV4 extends PermissionRequestTask {
    Fragment fragment;

    public PermissionRequestTaskStartFragmentV4(Fragment fragment) {
     ...
     */
    @Override
    public PermissionRequestTaskStartFragmentV4 request(@NonNull int requestCode, @NonNull String... pers) {
